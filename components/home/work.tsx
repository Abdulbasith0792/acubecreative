      ...
      >Some of Out Finest Work</div>
        <div className=''>
               ...
               {/* <div className='text-white text-3xl absolute'>hello</div> */}
                ...
                <Link href='https://www.instagram.com/smalltown_esports/' target='_blank' className='w-full'><button className='px-6 py-2 bg-orange-500 rounded-full mt-7 font-semibold tracking-wide lg:hidden block'>View More....</button></Link>
                </div>
                </div>
               ...
               {/* <div className='text-white text-3xl absolute'>hello</div> */}
                ...
                <div className='text-white flex flex-col gap-4 items-center bg-gray-700 dark:bg-gray-900 px-2 lg:px-10 py-14 lg:rounded-2xl bg-opacity-25 dark:bg-opacity-30 lg:bg-opacity-100 dark:lg:bg-opacity-100  w-screen lg:w-fit'>
                  ...
                  <div className='text-zinc-300 lg:text-zinc-300/50 break-words text-center'>PixlWorx: Elevate Your Style with Trendsetting Phone Cases, Mugs, and More for a Pixel-Perfect Lifestyle.</div>
                  <Link className='' href='https://www.pixlworx.com/' target='_blank'><div className=' underline underline-offset-2 text-zinc-300 lg:text-zinc-300/70 break-words text-center'>https://www.pixlworx.com/</div></Link>
