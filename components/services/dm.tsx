...
import dm from '../../public/assets/animations/dm_anime.json'
...
const Dm = () => {
  return (
    <div className='lg:px-28'>
        <div className='lg:text-center text-[28px] mt-3 lg:mt-0 lg:text-[40px] px-3 lg:px-0 text-fuchsia-600 dark:text-fuchsia-400' style={rowdies.style}>Digital Marketing</div>
        ...
        <div className='px-5 lg:w-[90%]'>
            ...
            <div style={nunito.style}  className='text-[26px] leading-snug mt-5  lg:text-[35px] font-bold break-words'>Crafting brand perceptions by using different tools and with an expert team to elevate customer experiences</div>
        </div>
        <div className="w-[40vh] lg:w-[99vh]  lg:mt-0 ">
          <Lottie animationData={dm} loop={true} />
        </div>
        </div> 
        <div className='mt-16 px-5'>
        {/* <div style={nunito.style} className='text-blue-600  dark:text-orange-500 text-lg lg:text-xl font-bold mb-10 '>Web.</div> */}
        <div style={nunito.style}  className='grid grid-cols-2 lg:grid-cols-3 lg:gap-x-10 gap-y-5 text-2xl font-bold underline decoration-dotted underline-offset-2'>
               
                    <div>Branding</div>
                    <div>Facebook Ads</div>
                    <div className=''>Google AdSense</div>
...
<div className='grid grid-cols-1 lg:grid-cols-2 items-start gap-y-10 gap-x-20 px-1 lg:px-0'>
   <div>
<div className='text-5xl mb-6 '><VscGraph /></div>
   ...
   <div className='text-5xl mb-6 '> <GiShieldOpposition /></div>
    ...
    <div  style={nunito.style} className='text-md  lg:text-[17px] leading-relaxed font-medium break-all text-zinc-800/70 dark:text-zinc-100/60'>
