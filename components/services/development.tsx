...
<div className='grid grid-cols-1 lg:grid-cols-2 items-start gap-y-10 gap-x-20'>
   <div>
    ...
    <div  style={nunito.style} className='text-md  lg:text-[17px] leading-relaxed font-medium text-zinc-800/70 dark:text-zinc-100/60'>As a web and mobile app development company dedicated to client satisfaction, we delve deeply 
   ...
   <div>
    ...
    <div  style={nunito.style} className='text-md  lg:text-[17px] leading-relaxed font-medium text-zinc-800/70 dark:text-zinc-100/60'>Leveraging a technology-centric approach, our solutions go beyond conventional problem-solving methods. We guarantee a refined frontend experience and construct a user-friendly backend by envisioning a comprehensive perspective, 
   ...
   <div>
    <div  style={nunito.style} className='mb-5 text-xl lg:text-2xl font-bold'>Understand Objectives</div>
    <div  style={nunito.style} className='text-md  lg:text-[17px] leading-relaxed font-medium text-zinc-800/70 dark:text-zinc-100/60d'>As a web and mobile app development company dedicated to client satisfaction, we delve deeply 
        into your digital needs, understanding consumer behaviors, technology platforms, functionalities, and more. Our strategy focuses on crafting the ideal user experience, prioritizing exceptional aesthetic appeal to captivate your audience and provide a competitive advantage.</div>
   </div>
</div>
        </div>
